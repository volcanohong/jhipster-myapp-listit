...
export const LocationUpdate = (props: ILocationUpdateProps) => {
  ...
  const { locationEntity, cities, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="listitApp.location.home.createOrEditLabel">
            <Translate contentKey="listitApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : locationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="postCodeLabel" for="location-postCode">
              ...
              <AvGroup>
                ...
                <AvInput id="location-city" type="select" className="form-control" name="cityId">
                  <option value="" key="0" />
                  {cities
